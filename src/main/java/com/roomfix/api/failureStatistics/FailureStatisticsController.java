...
public class FailureStatisticsController {
    ...
    public ArrayList<StatisticsDto> getSummary(String type, boolean byId, long id){
    ...
    public void failuresCount(StatisticsDto statisticsDto, List<Failure> failureList, long elementId, boolean elementIsBuilding){
